...
private:
    ...
    bool isFunction;       // true if this symbol is a function
    bool isDefined;        // true if function definition is encountered
    bool isArray;          // true if variable is an array
    int arraySize;         // array length
    

    bool isGlobal;         // true if variable is in global scope
    int offset;            // EBP-relative stack offset for local variables (e.g., -4, -8)
